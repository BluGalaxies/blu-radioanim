RegisterCommand("+radiochatter", function(source, args, rawCommand)
	TriggerEvent( 'Radio', source )
end)
...
RegisterKeyMapping('+radiochatter', '~g~Hold Radio', 'keyboard', 'LMENU')





-- Credits to HelpIHaveEbola
